...
pipes.builtVendorScriptsProd = function() {
    return gulp.src('./app/node_modules/*.js')
...
pipes.builtIndexProd = function() {
    ...
    return pipes.validatedIndex()
        ...
        .pipe(plugins.inject(vendorScripts, {relative: true}))
...
//TODO: Remote below. testing only
/*
gulp.task('task_buildIndex', function () {
  var target = gulp.src('./app/index.html');
  // It's not necessary to read the files (will speed up things), we're only after their paths: 
  var sources = gulp.src(['./app/common/phone-list/*.js'], {read: false});
...
*/
gulp.task("task_buildIndex", pipes.builtAppProd);
//END OF TODO


// default task builds for prod
//gulp.task('default', ['clean-build-app-prod']);
gulp.task('default', ['task_buildIndex']);
